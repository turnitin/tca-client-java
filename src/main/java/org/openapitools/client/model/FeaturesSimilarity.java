...
public class FeaturesSimilarity {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("viewer_modes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FeaturesSimilarity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeaturesSimilarity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeaturesSimilarity is not found in the empty JSON string", FeaturesSimilarity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FeaturesSimilarity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeaturesSimilarity` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `viewer_modes`
      if (jsonObj.get("viewer_modes") != null && !jsonObj.get("viewer_modes").isJsonNull()) {
        FeaturesViewerModes.validateJsonObject(jsonObj.getAsJsonObject("viewer_modes"));
      }
      // validate the optional field `generation_settings`
      if (jsonObj.get("generation_settings") != null && !jsonObj.get("generation_settings").isJsonNull()) {
        FeaturesGenerationSettings.validateJsonObject(jsonObj.getAsJsonObject("generation_settings"));
      }
      // validate the optional field `view_settings`
      if (jsonObj.get("view_settings") != null && !jsonObj.get("view_settings").isJsonNull()) {
        FeaturesSimilarityViewSettings.validateJsonObject(jsonObj.getAsJsonObject("view_settings"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeaturesSimilarity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeaturesSimilarity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeaturesSimilarity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeaturesSimilarity.class));

       return (TypeAdapter<T>) new TypeAdapter<FeaturesSimilarity>() {
           @Override
           public void write(JsonWriter out, FeaturesSimilarity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FeaturesSimilarity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FeaturesSimilarity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeaturesSimilarity
  * @throws IOException if the JSON string is invalid with respect to FeaturesSimilarity
  */
  public static FeaturesSimilarity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeaturesSimilarity.class);
  }

 /**
  * Convert an instance of FeaturesSimilarity to an JSON string
  *
  * @return JSON string
  */
