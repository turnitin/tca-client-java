...
public class WebhookApi {
    ...
    public ApiResponse<Webhook> getWebhookWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<Webhook>(){}.getType()));
            e.setErrorObjectType(new GenericType<Webhook>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<List<Webhook>> webhooksGetWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<List<Webhook>>(){}.getType()));
            e.setErrorObjectType(new GenericType<List<Webhook>>(){});
            throw e;
        }
    }
