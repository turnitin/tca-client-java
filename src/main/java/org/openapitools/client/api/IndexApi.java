...
public class IndexApi {
    ...
    private okhttp3.Call getIndexStatusValidateBeforeCall(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, final ApiCallback _callback) throws ApiException {
        ...
        return getIndexStatusCall(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, _callback);
     ...
     * @param xTurnitinIntegrationVersion the version of the integration platform being used (required)
     * @param id The Submission ID (returned upon a successful POST to /submissions)  (required)
     * @param asynchronous asynchronous request (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call indexSubmissionCall(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, Boolean asynchronous, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexSubmissionValidateBeforeCall(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, Boolean asynchronous, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xTurnitinIntegrationName' is set
        if (xTurnitinIntegrationName == null) {
        ...
        return indexSubmissionCall(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, asynchronous, _callback);
     ...
     */
    public IndexStateSettings indexSubmission(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, Boolean asynchronous) throws ApiException {
        ApiResponse<IndexStateSettings> localVarResp = indexSubmissionWithHttpInfo(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, asynchronous);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IndexStateSettings> indexSubmissionWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, Boolean asynchronous) throws ApiException {
        okhttp3.Call localVarCall = indexSubmissionValidateBeforeCall(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, asynchronous, null);
        Type localVarReturnType = new TypeToken<IndexStateSettings>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call indexSubmissionAsync(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id, Boolean asynchronous, final ApiCallback<IndexStateSettings> _callback) throws ApiException {

        okhttp3.Call localVarCall = indexSubmissionValidateBeforeCall(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, asynchronous, _callback);
        Type localVarReturnType = new TypeToken<IndexStateSettings>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
