...
public class IndexApi {
    ...
    public ApiResponse<IndexStateSettings> getIndexStatusWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String id) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<IndexStateSettings>(){}.getType()));
            e.setErrorObjectType(new GenericType<IndexStateSettings>(){});
            throw e;
        }
    }
