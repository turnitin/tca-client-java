...
public class GroupsApi {
    ...
    public ApiResponse<AddGroupAttachmentResponse> addGroupAttachmentWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String groupId, AddGroupAttachmentRequest data) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<AddGroupAttachmentResponse>(){}.getType()));
            e.setErrorObjectType(new GenericType<AddGroupAttachmentResponse>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<AggregateGroup> getGroupWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String groupId) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<AggregateGroup>(){}.getType()));
            e.setErrorObjectType(new GenericType<AggregateGroup>(){});
            throw e;
        }
    }
    ...
    public ApiResponse<GroupAttachmentResponse> getGroupAttachmentWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion, String groupId, String attachId) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<GroupAttachmentResponse>(){}.getType()));
            e.setErrorObjectType(new GenericType<GroupAttachmentResponse>(){});
            throw e;
        }
    }
