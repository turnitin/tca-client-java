...
public class FeaturesApi {
    ...
    public ApiResponse<FeaturesEnabled> featuresEnabledGetWithHttpInfo(String xTurnitinIntegrationName, String xTurnitinIntegrationVersion) throws ApiException {
        ...
        try {
            ...
            e.setErrorObject(localVarApiClient.getJSON().getGson().fromJson(e.getResponseBody(), new TypeToken<FeaturesEnabled>(){}.getType()));
            e.setErrorObjectType(new GenericType<FeaturesEnabled>(){});
            throw e;
        }
    }
