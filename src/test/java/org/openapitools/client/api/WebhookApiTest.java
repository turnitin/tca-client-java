...
public class WebhookApiTest {
    ...
    public void deleteWebhookTest() throws ApiException {
        ...
        String id = null;
        api.deleteWebhook(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id);
    ...
    public void getWebhookTest() throws ApiException {
        ...
        String xTurnitinIntegrationVersion = null;
        String id = null;
        Webhook response = api.getWebhook(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id);
    ...
    public void updateWebhookTest() throws ApiException {
        ...
        String xTurnitinIntegrationVersion = null;
        String id = null;
        WebhookPathRequest data = null;
        Webhook response = api.updateWebhook(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, data);
    ...
    public void webhooksGetTest() throws ApiException {
        String xTurnitinIntegrationName = null;
        String xTurnitinIntegrationVersion = null;
        List<Webhook> response = api.webhooksGet(xTurnitinIntegrationName, xTurnitinIntegrationVersion);
    ...
    public void webhooksPostTest() throws ApiException {
        String xTurnitinIntegrationName = null;
        String xTurnitinIntegrationVersion = null;
        WebhookWithSecret data = null;
        Webhook response = api.webhooksPost(xTurnitinIntegrationName, xTurnitinIntegrationVersion, data);
