...
public class FeaturesApiTest {
     ...
     */
    @Test
    public void featuresEnabledGetTest() throws ApiException {
        String xTurnitinIntegrationName = null;
        String xTurnitinIntegrationVersion = null;
                FeaturesEnabled response = api.featuresEnabledGet(xTurnitinIntegrationName, xTurnitinIntegrationVersion);
